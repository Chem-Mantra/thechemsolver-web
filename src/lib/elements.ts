// Shared element symbol/name reference data (Z=1..118), reused across labs
// that need a basic periodic-table lookup (electron config, PES spectrum,
// mass spec, etc.) — kept lightweight (no electronegativity/density/etc.,
// see src/app/labs/periodic-table for the fuller dataset).
...
export type ElementInfo = { z: number; sym: string; name: string }

export const ELEMENTS: ElementInfo[] = ELEMENT_SYMBOLS.map((sym, i) => ({ z: i + 1, sym, name: ELEMENT_NAMES[i] }))
