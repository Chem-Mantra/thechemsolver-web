  ...
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-5">
      <p className="mb-4 font-medium text-white">
        <span className="mr-2 text-sm font-bold text-indigo-400">Q{index + 1}.</span>
        {mcq.question}
      </p>
      ...
      {!submitted && (
        <button
          ...
          className="mt-4 rounded-lg bg-indigo-600 px-5 py-2 text-sm font-semibold text-white transition hover:bg-indigo-500 disabled:opacity-40"
        >
          Check Answer
        </button>
      )}
