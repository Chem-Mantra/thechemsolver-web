...
import { CH03 } from './content/ch03'
import { CH04 } from './content/ch04'
import { CH05 } from './content/ch05'
import { CH06 } from './content/ch06'
import { CH07 } from './content/ch07'
import { CH08 } from './content/ch08'
import { CH09 } from './content/ch09'
import { CH10 } from './content/ch10'
import { CH11 } from './content/ch11'
import { CH12 } from './content/ch12'
import { CH13 } from './content/ch13'
import { CH14 } from './content/ch14'
import { CH15 } from './content/ch15'
import { CH16 } from './content/ch16'
import { CH17 } from './content/ch17'
import { CH18 } from './content/ch18'
import { CH19 } from './content/ch19'
import { CH20 } from './content/ch20'
import { CH21 } from './content/ch21'
import { CH22 } from './content/ch22'
import ConceptView from './components/ConceptView'
import type { Concept, OrgoChapter } from './types'

const STORAGE_KEY = 'orgo_ebook_v1'

const CHAPTERS: OrgoChapter[] = [
    ...
    >
      ...
      >
        <div className="border-b border-slate-800 p-4">
          <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Orgo 1 & 2</p>
          <p className="mt-0.5 text-sm font-bold text-white">Organic Chemistry Ebook</p>
          <div className="mt-3 flex items-center gap-3">
            ...
            <span className="text-xs font-semibold text-emerald-400">{overallPct}%</span>
          </div>
              ...
              <div key={chapter.id} className="mb-4">
                <div className="mb-2 flex items-center gap-2 px-2">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-slate-500">Orgo {chapter.orgo}</p>
                  </div>
                </div>
