  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div
          className="absolute inset-0 flex flex-col items-center justify-center rounded-2xl border border-emerald-800 bg-gradient-to-br from-emerald-950 to-slate-900 px-6 text-center"
          style={{ backfaceVisibility: 'hidden' }}
        >
          <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-emerald-400">Question</p>
