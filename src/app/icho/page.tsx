...
const GATEWAY = [
  ...
  },
  {
    ...
    desc: 'The Advanced Chemistry interactive ebook — 7 chapters covering exactly what IChO tests beyond AP/Orgo level: analytical chemistry, advanced kinetics, thermodynamics, equilibrium, electrochemistry, spectroscopy, and solid state.',
